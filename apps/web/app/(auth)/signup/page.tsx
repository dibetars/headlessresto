    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-gray-100 space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2 text-sm">Create your restaurant account</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-500">
          Already have an account? <a href="/login" className="hover:underline text-primary font-semibold">Sign In</a>
        </div>
      </div>
    </div>
  );
